...
<body>
            ...
            <div class="card position-absolute top-50 start-50 translate-middle text-light margen-custom">
                <div class="row">
                    <div class="col-7 mt-4 ms-4">
                        <h5 class="card-title position-absolute">Subir un spot</h5>
                ...
                <form action="./subir_lugar_db.php" method="POST" type="POST" enctype="multipart/formdata" >
                    <div class="card-body mt-4">
                        <label for="exampleFormControlInput1" class="form-label ">Nombre del spot</label>
                        <input type="text" class="form-control alt mb-4" placeholder="Ponle un nombre al spot" name="nombre" required>
                        ...
                        <input type="text" class="form-control alt" placeholder="Estado del spot" name="estado" required>
                        <label for="exampleFormControlInput1" class="form-label mt-4">Acceso</label>
                        <input type="text" class="form-control alt" placeholder="Por donde se entra spot" name="acceso" required>
                        <label for="exampleFormControlInput1" class="form-label mt-4">Peligros</label>
                        <input type="text" class="form-control alt" placeholder="Peligros del spot" name="peligros" required>
                        <label for="exampleFormControlInput1" class="form-label mt-4">Descripción</label>
                        <input type="text" class="form-control alt" placeholder="Una descripción del spot" name="descripcion" required>
                        ...
                        <input type="file" class="form-control alt" placeholder="fotos" name="fotos" title="inserta fotos del spot">
                        <label for="exampleFormControlInput1" class="form-label mt-4">Localizacion</label>
                        <input type="text" class="form-control alt" placeholder="Una descripción del spot" name="localizacion" required>
                        <label for="exampleFormControlInput1" class="form-label mt-4">latitud</label>
                        <input type="text" class="form-control alt" placeholder="Una descripción del spot" name="latitud" required>
                        <label for="exampleFormControlInput1" class="form-label mt-4">longitud</label>
                        <input type="text" class="form-control alt" placeholder="Una descripción del spot" name="longitud" required>  
                    </div>
    ...
    <section class="bg-custom vh-100">
